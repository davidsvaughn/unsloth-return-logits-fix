...
def compute_metrics(eval_pred):
    ...
    mask = labels != -100
    correct_predictions = (predicted_ids == labels) & mask
    total_valid_predictions = mask.sum()
    accuracy = correct_predictions.sum() / total_valid_predictions if total_valid_predictions > 0 else 0.0
